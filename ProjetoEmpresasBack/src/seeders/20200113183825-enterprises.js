...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('enterprises', [{
      ...
      contry: 'Brasil',
      type: 1,
      description_type: 'Time de Futebol',
      created_at: new Date(),
      updated_at: new Date()
    },
    {
      ...
      type: 4,
      description_type: 'Calçados e Equipamentos Esportivos',
      created_at: new Date(),
      updated_at: new Date()
    },
    {
      ...
      type: 3,
      description_type: 'Telefonia e Tecnologia',
      created_at: new Date(),
      updated_at: new Date()
    },
    {
      ...
      contry: 'China',
      type: 2,
      description_type: 'Indústria de Jogos Eletrônicos',
      created_at: new Date(),
      updated_at: new Date()
    }
    ])
